...
const CollectionPage = () => {
    ...
    return (
        <div id="products" className="w-full bg-black text-white py-16">
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="text-center mb-16">
                    ...
                    <p
                        ...
                        style={{ fontFamily: "'Poppins', sans-serif" }}
                    >
                        Discover our carefully curated selection of premium menswear, designed for the
                        discerning gentleman who values quality and style.
                    </p>
                </div>
                ...
                {loading ? (
                    ...
                    <div className="flex justify-center items-center py-16">
                        <div className="text-xl text-gray-400" style={{ fontFamily: "'Poppins', sans-serif" }}>
                            No products found. Please add some products to the collection.
                        </div>
                    </div>
                )}
            </div>
